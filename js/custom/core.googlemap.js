    ...
    for (var i in THEMEREX_GLOBALS['googlemap_init_obj'][id].markers) {
        ...
        if (THEMEREX_GLOBALS['googlemap_init_obj'][id].markers[i].latlng == '') {
            ...
            if (THEMEREX_GLOBALS['googlemap_init_obj'][id].markers[i].description!='') {
                ...
                google.maps.event.addListener(THEMEREX_GLOBALS['googlemap_init_obj'][id].markers[i].marker, 'mouseover', function(e) {
                ...
                google.maps.event.addListener(THEMEREX_GLOBALS['googlemap_init_obj'][id].markers[i].marker, 'mouseout', function() {
                    for (var i in THEMEREX_GLOBALS['googlemap_init_obj'][id].markers) {
                        THEMEREX_GLOBALS['googlemap_init_obj'][id].markers[i].infowindow.close();
                    }
                });
